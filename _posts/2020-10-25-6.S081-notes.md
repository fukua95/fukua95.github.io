...
给trap专用使用的寄存器集合可以看RISC-V文档，和xv6的riscv.h，以下列举几个寄存器:  
...
**The above registers relate to traps handled in suupervisor mode, and they cannot be read or written in user mode**.
